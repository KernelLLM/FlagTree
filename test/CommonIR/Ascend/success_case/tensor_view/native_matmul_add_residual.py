...
def matmul_add_residual_kernel(
    ...
    # tl.tensor_view over the whole logical residual/output matrices; both
    # are indexed by (pid_m, pid_n) tile position below.
    ...
    for block_idx in range(pid, NUM_BLOCKS, NUM_CORES):
        ...
        residual_tile = tl.load(residual_view, index=(pid_m, pid_n), tile=(BLOCK_M, BLOCK_N))
