...
def flash_attention_fwd_3task_kernel(
    Q, K, V, Out,
    workspace_s, workspace_p, workspace_pv,           # GM ping-pong workspaces (Cube↔Vector)
    workspace_rescale, workspace_expsum,              # GM ring-buffers for Vec1→Vec2 stats
    sm_scale,
    B, Hq, Hkv, S,
    sQb, sQh, sQs, sQd,
    sKb, sKh, sKs, sKd,
