...
// Build a CommonIR MemorySpaceAttr from a Python-supplied address-space
// attribute. A null attribute yields a null MemorySpaceAttr, which the
// lowering treats as UB.
